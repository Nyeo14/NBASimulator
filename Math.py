...
response = requests.get("https://www.balldontlie.io/api/v1/season_averages?season=2018&player_ids[]=15")
...
for player in playerStats["data"]:
    ...
    player["fg3m"], player["fg3a"], player["fg3_pct"], player["ft_pct"], player["ftm"]]
print(statDict)
...
for key, value in statDict.items():
    ...
    total = value[0]*0.75 + value[1]*0.75 + value[2]*0.25 + value[3]*1.25 + value[4] - value[5] + adjfg2m + adjfg3m + adjftm
    totalDict[key] = total
print(totalDict)
